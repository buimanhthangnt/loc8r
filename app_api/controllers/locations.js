...
module.exports.locationsListByDistance = function (req, res) {
	...
	var geoOptions = {spherical: true, maxDistance: theEarth.getRadsFromDistance(maxDistance), num: 10};
	if (!lng || !lat) {
		sendJsonResponse(res, 404, {"message" : "lng and lat query paramaters are required"});
		return;
	}
